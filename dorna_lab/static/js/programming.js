...
var xml_initial = '<xml xmlns="https://developers.google.com/blockly/xml"><block type="code" id="XJ}//PDMs0.pK*:;k2ds" x="90" y="90"><field name="input">import time&amp;#10;from dorna2 import Dorna&amp;#10;</field><next><block type="method" id="xW#O_,PzTjYigb~/{g~T"><field name="name">main(robot)</field><statement name="statement"><block type="jmove" id="t5~PX3m8-ldlqUV{!Q{q"><mutation inputs="ret,ADD0,ADD1,ADD2,ADD3,ADD4" next="5"></mutation><value name="ADD0"><block type="coord_list" id="=VAJxHGN}SH$lkiR!H{6"><field name="label">j0</field><value name="input"><block type="math_number" id="s..(fS[v;3ZNk}q$f@.S"><field name="NUM">0</field></block></value></block></value><value name="ADD1"><block type="rapid_list" id="=Rp?TvKe}g}88vu6-1@A"><field name="label">vel</field><value name="input"><block type="num_0_inf_0" id="0U.y8lEqj!8_19}xGT:k"><field name="NUM">0</field></block></value></block></value><value name="ADD2"><block type="val_list" id="e|Y*d]O2fC018Ca*DE$_"><field name="label">rel</field><value name="input"><block type="num_0_1_1" id="gXD_=^=wm1c0%R4.RO2_"><field name="NUM">0</field></block></value></block></value><value name="ADD3"><block type="label_text" id="W..,,A@gK+3=txQ}tX4Z"><field name="label">timeout</field><value name="input"><block type="math_number" id="I;ZwsUTwh)JV#/uK_-~2"><field name="NUM">-1</field></block></value></block></value></block></statement><next><block type="code" id="sv?-N%V{]OMvW~Z=L38?"><field name="input">if __name__ == "__main__":&amp;#10;    robot = Dorna()&amp;#10;    robot.connect(host="localhost", port=443)&amp;#10;    main(robot)&amp;#10;    robot.close()</field></block></next></block></next></block></xml>'
