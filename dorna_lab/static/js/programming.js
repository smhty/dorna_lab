...
var xml_initial = '<xml xmlns="https://developers.google.com/blockly/xml"><block type="code" id="XJ}//PDMs0.pK*:;k2ds" x="90" y="90"><field name="input">import time&amp;#10;from dorna2 import Dorna&amp;#10;</field><next><block type="method" id="xW#O_,PzTjYigb~/{g~T"><field name="name">main(robot)</field><statement name="statement"><block type="jmove" id="M)PO$2y;tMuS|L~l3TM["><mutation inputs="ret,ADD0,ADD1,ADD2,ADD3,ADD4" next="5"></mutation><value name="ADD0"><block type="label_text" id="F:Q)vFU/XH50(,*bG#5p"><field name="label">timeout</field><value name="input"><block type="math_number" id="jO4;NIh`qoh9;0?7,[OK"><field name="NUM">-1</field></block></value></block></value><value name="ADD1"><block type="val_list" id="I_-bs[Rhs|xEyB%*3d*x"><field name="label">rel</field><value name="input"><block type="0_1_drpdown" id="E;DxBM1.3mdfK4E=Rc@K"><field name="label">0</field></block></value></block></value><value name="ADD2"><block type="rapid_list" id="w*|w.G[qdZz*~#$qCqoo"><field name="label">vel</field><value name="input"><block type="num_0_inf_0" id="2/IliQ^x2f/0cHG3?u#D"><field name="NUM">100.0</field></block></value></block></value><value name="ADD3"><block type="coord_list" id="oJK_Ky,z}J4bG=A6fC]S"><field name="label">j0</field><value name="input"><block type="math_number" id="{,W5(p8|2@)+=UieqT3!"><field name="NUM">0</field></block></value></block></value></block></statement><next><block type="code" id="sv?-N%V{]OMvW~Z=L38?"><field name="input">if __name__ == "__main__":&amp;#10;    robot = Dorna()&amp;#10;    robot.connect(host="localhost", port=443)&amp;#10;    main(robot)&amp;#10;    robot.close()</field></block></next></block></next></block></xml>'
