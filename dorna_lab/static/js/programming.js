...
var xml_initial = '<xml xmlns="https://developers.google.com/blockly/xml"><block type="code" id="XJ}//PDMs0.pK*:;k2ds" x="90" y="70"><field name="input">import time&amp;#10;from dorna2 import Dorna&amp;#10;</field><next><block type="method" id="xW#O_,PzTjYigb~/{g~T"><field name="name">main(robot)</field><statement name="statement"><block type="jmove" id="au`vcZ,r{v9[)x=@j-m{"><mutation inputs="ret,ADD0,ADD1,ADD2,ADD3" next="4"></mutation><value name="ADD0"><block type="set_label" id="Ve]KdJ?QMFz%hoBt1iWt"><value name="label"><block type="coord_list" id="JIw,{G.}48a8GO8f^hHx"><field name="label">j0</field></block></value><value name="input"><block type="math_number" id="5e(_j5(?ft5,)OSv(3cp"><field name="NUM">0</field></block></value></block></value><value name="ADD1"><block type="set_label" id=",-`8ZWU,Rmg$}Bz2zhRc"><value name="label"><block type="rapid_list" id="w@gTMSHWr%PhwT?Ts{|0"><field name="label">vel</field></block></value><value name="input"><block type="num_0_inf_0" id="eHC+8*y{.IeiZEMHy%zT"><field name="NUM">0</field></block></value></block></value><value name="ADD2"><block type="set_label" id="a+]YHqHg95oEbDP~Ba49"><value name="label"><block type="val_list" id="ogC{+bNDx||:z:5~KgOO"><field name="label">rel</field></block></value><value name="input"><block type="num_0_1_1" id="RFElA+I;eiozlsSQax%U"><field name="NUM">0</field></block></value></block></value><value name="ADD3"><block type="set_label" id="i841TOm5j3H;,,fRK7iw"><value name="label"><block type="label_text" id="GQ7KH#wYG1)96:)]*{%4"><field name="label">timeout</field></block></value><value name="input"><block type="math_number" id="a;A91u|*lb@Yt`_Qe5T~"><field name="NUM">-1</field></block></value></block></value></block></statement><next><block type="code" id="sv?-N%V{]OMvW~Z=L38?"><field name="input">if __name__ == "__main__":&amp;#10;    robot = Dorna()&amp;#10;    robot.connect(host="localhost", port=443)&amp;#10;    main(robot)&amp;#10;    robot.close()</field></block></next></block></next></block></xml>'
