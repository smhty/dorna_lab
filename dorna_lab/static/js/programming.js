...
var xml_initial = '<xml xmlns="https://developers.google.com/blockly/xml"><block type="code" id="XJ}//PDMs0.pK*:;k2ds" x="130" y="90"><field name="input">import time&amp;#10;from dorna2 import Dorna&amp;#10;</field><next><block type="method" id="xW#O_,PzTjYigb~/{g~T"><field name="name">main(robot)</field><statement name="statement"><block type="jmove" id="zD+FPWvZCCgROZWk[GH3"><mutation inputs="ret,ADD0,ADD1,ADD2,ADD3,ADD4" next="5"></mutation><value name="ADD0"><block type="set_label" id="4qk}_9l@wwzwxjXKCdsj"><value name="label"><block type="coord_list" id="vP)j2yxK.bCxzqI9BcO{"><field name="label">j0</field></block></value><value name="input"><block type="math_number" id="o5lI/s5ynuL}[?2`#pl("><field name="NUM">0</field></block></value></block></value><value name="ADD1"><block type="set_label" id="/)5d;#e:0NUMQ#lTs?Qd"><value name="label"><block type="rapid_list" id="_,T$P3399.H_Q@4-P^*_"><field name="label">vel</field></block></value><value name="input"><block type="num_0_inf_0" id="`{9{#Tl-N_1WU6n1|Rbm"><field name="NUM">0</field></block></value></block></value><value name="ADD2"><block type="set_label" id="GEd9i~pP/Vb}ikz0vt`L"><value name="label"><block type="val_list" id="wD6Ru:M-_%!TXn-PenW["><field name="label">rel</field></block></value><value name="input"><block type="num_0_1_1" id="3Ct-9G9K4x1ymWvEHX.("><field name="NUM">0</field></block></value></block></value><value name="ADD3"><block type="set_label" id="z,_9K3jb`Bq#_T)aM|q7"><value name="label"><block type="label_text" id="E4yEJI$Ey#20m/F9(Jl["><field name="label">timeout</field></block></value><value name="input"><block type="math_number" id="5EUlUjxU!k`OZAUha~+c"><field name="NUM">-1</field></block></value></block></value></block></statement><next><block type="code" id="sv?-N%V{]OMvW~Z=L38?"><field name="input">if __name__ == "__main__":&amp;#10;    robot = Dorna()&amp;#10;    robot.connect(host="localhost", port=443)&amp;#10;    main(robot)&amp;#10;    robot.close()</field></block></next></block></next></block></xml>'
  ...
  for(b in l){
      ...
      let elem = `<div class="list-group-item">
              ...
              <div class="d-flex w-100">
                ...
                <button type="button" class="btn btn-primary btn-sm rounded-0 ml-2 retry_btn" data-key=`+a[0]+` dir=`+a[5]+` >Duplicate & Run Process</button>
              </div>              
            </div>`
