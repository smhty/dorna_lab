(function (global, factory) {
    ...
    class Viewer {
        ...
        init() {
            ...
            this.simpleScene = this.simpleScene || new THREE__namespace.Scene();
        ...
        setupSimpleObjectDepthOverrideMaterial() {
            this.simpleObjectDepthOverrideMaterial = new THREE__namespace.ShaderMaterial({
                vertexShader: `
                #include <common>
                void main() {
                    gl_Position = projectionMatrix * viewMatrix * modelMatrix * vec4(position.xyz, 1.0);   
        ...
        updateSplatMeshUniforms = function() {
            ...
            return function() {
                ...
                if (splatCount > 0) {
                    this.getRenderDimensions(renderDimensions);
                    this.cameraFocalLength = (renderDimensions.y / 2.0) / Math.tan(this.camera.fov / 2.0 * THREE__namespace.MathUtils.DEG2RAD);
